	...
	<ul>
		<?php foreach ($current_objectives as $datas): ?>
			<li class="box_content">
				<h4>
					<button class="btn btn-primary btn-small" value="follow_objective">Suivre</button>
					<button class="btn btn-primary btn-small" value="unfollow_objective">Ne plus suivre</button>
